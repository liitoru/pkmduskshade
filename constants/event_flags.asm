...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_WILLOW
	const EVENT_BEAT_BUG_CATCHER_MATEO
; Camper
...
; Bird Keeper
	...
	const EVENT_BEAT_BIRD_KEEPER_ISAAC
; Hiker
	...
	const EVENT_BEAT_HIKER_DERECK
	const EVENT_BEAT_HIKER_LUKE
; GruntM
...
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_CARLSON
; Cosplayer
...
; Miscellaneous
	...
	const EVENT_FOUGHT_CAVE_TAUROS
	const EVENT_FOUGHT_TAUROS
